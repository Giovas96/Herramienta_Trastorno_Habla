...
public class Opciones_Galeria_Anonymous extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_opciones__galeria__anonymous);
            ...
            back.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    Intent b = new Intent(Opciones_Galeria_Anonymous.this, Listar_actividades_anonymous.class);
                    startActivity(b);
                }
            });
            ...
            jbtnPlay.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Intent c = new Intent(Opciones_Galeria_Anonymous.this, Galeria_integracion.class);
                    c.putExtras(bundle);
                    startActivity(c);
